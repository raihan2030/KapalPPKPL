                    ...
                    <?php if($inspeksi->status_validasi === 'validated' && $inspeksi->is_locked): ?>
                        <script>
                            document.getElementById('generateBtn').addEventListener('click', async function() {
                                ...
                                try {
                                    const response = await fetch('/reports/<?php echo e($inspeksi->id_inspeksi); ?>/generate', {
                                        method: 'POST',
                                        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\natal\Tugas PPKPL\KapalPPKPL\resources\views/ultrasonic/result.blade.php ENDPATH**/ ?>